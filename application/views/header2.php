        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="https://www.factions.cl">
                         <img src="<?php echo base_url('assets/images/factions-blanco-logo-156x61.png'); ?>" alt="" title="" style="height: 6rem;">
                    </a>
                </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
                ...
                <li class="nav-item dropdown"><a class="nav-link link text-white dropdown-toggle display-4" href="<?=site_url("main/codigos")?>" aria-expanded="false" data-toggle="dropdown-submenu">
                        ...
                        <li class="nav-item"><a class="nav-link link text-white display-4" href="<?=site_url("user/profile")?>" aria-expanded="false"><span class="mbri-user mbr-iconfont mbr-iconfont-btn"></span>
                        Perfil</a></li>
